...
import numpy as np
from panda_env_base import PandaEnvBase
from core.serializable import Serializable
from core.eval_util import get_stat_in_paths, \
    create_stats_ordered_dict
from gym.spaces import Box

class PandaReachXYZEnv(PandaEnvBase):
    def __init__(self,
                 fixed_goal=(0.5, 0.5, 0.5),
        ...
        PandaEnvBase.__init__(self, **kwargs)
